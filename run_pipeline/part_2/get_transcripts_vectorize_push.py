...
sawt_dir = os.path.abspath(os.path.join(part2_dir, "..", "..", ))
...
transcript_path = os.path.join(sawt_dir, "packages", "backend", "src", "json_test_directory", filename)

sys.path.append(sawt_dir)

from packages.pull.src.src2 import run_src
