...
print(part1_dir)
run_pipeline_dir = os.path.abspath(os.path.join(part1_dir, ".."))
print(run_pipeline_dir)
sawt_dir = os.path.abspath(os.path.join(run_pipeline_dir, ".."))
print(sawt_dir)
...
def run_download_and_YT(videos_to_process, df, LOG_FILE):
    ...
    def download_file(url, file_type=""):
        ...
        sys.path.append(run_pipeline_dir)
        save_download = os.path.join(run_pipeline_dir, "part_1", "downloaded_videos")
    ...
    client_secrets_path = os.path.join(sawt_dir, "run_pipeline","client_secret.json")
